export default {
  APM: [
    { name: 'APM/Coastline', url: 'https://publicdevelopment.cdn.appfolio.com/bootstrap-coastline/5.0.0-beta.1/bootstrap-coastline.css' },
  ...
  Bootstrap: [
    { name: 'Default', url: 'https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css' },
