  ...
  describe('uncontrolled', () => {
    ...
    it('should have address1', () => {
      ...
      input.simulate('change', {
        target: { name: 'address1', value: 'Batcave' },
      });
    ...
    it('should have address2', () => {
      ...
      input.simulate('change', {
        target: { name: 'address2', value: 'Secret Lair' },
      });
    ...
    it('should have city', () => {
      assert.strictEqual(
        component.find('.col-sm-6.pr-sm-3 #addressInput_city').hostNodes().length,
        1
      );
      ...
      input.simulate('change', {
        target: { name: 'city', value: 'Metropulos' },
      });
