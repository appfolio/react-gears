...
export const BadgeExample = () => <Badge />;

export const BlockPanelExample = () => {
  <BlockPanel title="Hello" onEdit={() => {}} expandable={false} hideOnToggle={false} open={false}>
    Now you see me.
  </BlockPanel>;
};
...
export const BreadcrumbExample = () => (
  <Breadcrumb>
    <BreadcrumbItem title="first" active />
    <BreadcrumbItem title="second" active />
  </Breadcrumb>
);
...
export const CalendarExample = () => {
  <Calendar date={new Date(2017, 7, 14)} dateVisible={(date) => date instanceof Date} />;
};
...
export const DeletedNoteExample = () => {
  ...
  <DeletedNote onUndelete={(n) => n} note={note} />;
};
...
export const FeatureBannerExample = () => {
  <FeatureBanner alertText="New" title="Hi" subtitle="Some title">
    <div>
      <Button className="fw-bold text-uppercase bg-muted text-primary" outline>
        Test
      </Button>
    </div>
  </FeatureBanner>;
...
export const FilterListExample = () => {
  ...
  <div>
    <FilterList filters={filters} maxWidth={14} onRemove={() => {}} />
  </div>;
};
...
export const MonthCalendarExample = () => {
  <MonthCalendar date={new Date(2017, 4, 20)} dateVisible={(d) => d instanceof Date} />;
};
...
export const SortableTableExample = () => {
  ...
  const columns = [
    {
      ...
      onSort: (ascending: boolean) => ascending === false,
      width: '50%',
    },
    {
      key: 'enabled',
  ...
  <SortableTable dark bordered striped columns={columns} rows={rows} />;
};
