  ...
  'className' | 'size' | 'id' | 'type' | 'onBlur' | 'onChange' | 'onClick' | 'onFocus' | 'onKeyDown' | 'disabled' | 'value' | 'defaultValue'>
{
  ...
  renderFooter?: (today?: VoidFunction, clear?: VoidFunction) => React.Component;
  renderHeader?: (prevMonth: VoidFunction, nextMonth: VoidFunction, prevYear: VoidFunction, nextYear: VoidFunction) => React.Component;
  showOnFocus?: boolean;
  state?: any;
  value?: DateOrString;
}
